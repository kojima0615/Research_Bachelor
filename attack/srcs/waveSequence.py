...
Y_MEMMAP_PATH = base + '/round9_sharesum_hd_v3_isomap_0-3000000_memmap.npy'
...
class waveSequence(Sequence):
    ...
    def __init__(self, batch_size, data_start, data_end):
        ...
        self.memmap_X = self.memmap_X[data_start:data_end,500:900]
        ...
        self.length = math.ceil(self.DATA_ROW_NUM / batch_size)
        print(self.memmap_X.shape)
        print(self.memmap_y.shape)
    ...
    def __getitem__(self, idx):
        ...
        inds = self.indices[start_idx:min(last_idx,self.DATA_ROW_NUM)]
