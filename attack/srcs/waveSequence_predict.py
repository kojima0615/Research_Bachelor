...
#X_MEMMAP_PATH = base + '/AES_TI_wave_mask_norm_v8_test_0-500000_1650_1700_memmap.npy'
#X_MEMMAP_PATH = base + '/AES_TI_wave_mask_div255_v8_test_0-500000_1650_1700_memmap.npy'
X_MEMMAP_PATH = base + '/AES_TI_wave_mask_div255_v8_test_0-500000_1200_1700_memmap.npy'
#X_MEMMAP_PATH = base + '/AES_TI_wave_mask_norm_vertical_same_v8_test_0-500000_1650_1700_memmap.npy'
#X_MEMMAP_PATH = base + '/AES_TI_wave_mask_norm_v8_test_0-500000_1650_1700_square_memmap.npy'
#X_MEMMAP_PATH = base + '/AES_TI_wave_unmask_norm_v6_test_0-500000_1650_1700_memmap.npy'
#batch_size = 128
CLASSES_NUM = 256
class waveSequence_pred(Sequence):
    """
