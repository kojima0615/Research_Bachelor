...
from waveSequence_noshuffle import *
...
def main():
    ...
    model: k.Model = eval(model_name + "({},{})".format(400,17))
    ...
    train_sequence = waveSequence(batch_size,0,900000)
    test_sequence = waveSequence_sh(batch_size,900000,1000000)
