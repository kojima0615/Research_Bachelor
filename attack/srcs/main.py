...
def main():
    ...
    (train_x, train_y), (test_x,test_y) = load_data.traces(dataset,model_name)

    model: k.Model = eval(model_name + "({},{})".format(train_x.shape[1],256*256))
    ...
    model.compile(
        ...
        metrics =[k.metrics.SparseCategoricalAccuracy('acc'), entropy_met]
