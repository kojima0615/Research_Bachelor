...
from waveSequence_v3 import *
from waveSequence_noshuffle_v3 import *
...
def main():
    ...
    model: k.Model = eval(model_name + "({},{})".format(1600,256))
    ...
    #train_sequence = waveSequence(batch_size,0,5700000)
    #test_sequence = waveSequence_sh(batch_size,5700000,6000000)
    train_sequence = waveSequence(batch_size,0,2700000)
    test_sequence = waveSequence_sh(batch_size,2700000,3000000)
