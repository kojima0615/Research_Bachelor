...
with open("./csv_data/plain_test_4000000_v2.csv") as f:
    plain_text = f.readlines()

with open("./csv_data/key_test_fixed_4000000_v2.csv") as f:
    key = f.readlines()
...
with open("./csv_data/round10_test_1byte_key_v2_isomap_0-1000000.csv", "w") as f:
    for ele in out:
        f.write(str(ele)+'\n')

with open("./csv_data/round10_test_1byte_v2_isomap_0-1000000.csv", "w") as f:
    for ele in out1:
        f.write(str(ele)+'\n')